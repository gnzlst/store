                            ...
                            <tr v-for="item in items">
                                <td class="medium-text-center">
                                    <a :href="'/product/' + item.id">
                                        <img :src="'/' + item.image" class="image-cart" alt="item.name">
                                    </a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button v-if="item.stock > item.quantity" @click="updateQuantity(item.id, '+')">
                                        <i class="fa fa-plus-square one-more" aria-hidden="true"></i>
                                    </button>
                                    <button v-if="item.quantity > 1" @click="updateQuantity(item.id, '-')">
                                        <i class="fa fa-minus-square one-less" aria-hidden="true"></i>
                                    </button>
                                </td>
                                <td>{{ item.total }}</td>
                            ...
                            <tr>
                                <td valign="top">
                                    <div class="input-group">
                                        <input type="text" name="coupon" class="input-group-field"
                                ...
                                <div class="text-right">
                                    ...
                                    <span v-else>
                                        <a href="/login" class="button success">
                                            <i class="fa fa-credit-card" aria-hidden="true"></i>&nbsp;Login
                                        </a>
                                    </span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mystore\resources\views/cart.blade.php ENDPATH**/ ?>