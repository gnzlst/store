        ...
        if (Request::has('post')) {
            ...
            if (CSRFToken::verifyCSRFToken($request->token)) {
                ...
                if (empty($filename)) {
                    ...
                    $file_error['productImage'] = ['The extension of the product image is invalid.'];
                } else if (!UploadFile::fileSize($filename)) {
                    $file_error['fileSize'] = ['The size of the image is too big.'];
                }
