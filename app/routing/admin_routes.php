...
$router->map('GET', '/admin/transactions/payments/?', 'App\Controllers\Admin\PaymentController@show', 'dashboard_transactions_payment');

$router->map('GET', '/admin/users/?', 'App\Controllers\Admin\UserController@show', 'user_show');
$router->map('POST', '/admin/users/register/?', 'App\Controllers\Admin\UserController@register', 'register_user');