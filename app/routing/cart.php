...
//$router->map('POST', '/paypal/create-payment', 'App\Controllers\CartController@paypalCreatePayment', 'paypal_create_payment');
//$router->map('POST', '/paypal/execute-payment', 'App\Controllers\CartController@paypalExecutePayment', 'paypal_execute_payment');